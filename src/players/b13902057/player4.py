...
class player4:
	...
	Crucially the strong ``*10`` take-avoidance is kept, and the gap term is
	used for BOTH our rollout moves and the simulated opponents, so the
	opponent model is more realistic too -- which is where player3 was capped
